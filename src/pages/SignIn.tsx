...
export function SignIn() {
    ...
    <div className='w-screen h-screen flex-col bg-gray-900 flex items-center justify-center text-gray-100'>
      ...
      <form onSubmit={handleSignIn} className='flex flex-col gap-4 items-strech w-full mt-10 max-w-sm'>
      ...
      <footer className='flex flex-col items-center gap-4 mt-8'>
        <Text asChild size='sm'>
          <a href="" className='text-gray-500 underline hover:text-gray-100'>Esqueceu sua senha</a>
        </Text>
        <Text asChild size='sm'>
          <a href="" className='text-gray-500 underline hover:text-gray-100'>Não Possui conta: Crie uma agora?</a>
        </Text>
